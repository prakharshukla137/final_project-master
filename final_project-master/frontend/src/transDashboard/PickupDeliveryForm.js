...
export default class PickupDeliveryForm extends Component {
    ...
    submitForm = (e) => {
      ...
      console.log(this.state.i_id,this.state.pickup_date,this.state.delivery_date);
        const url = "http://localhost:8090/transporter/pickupdeliverydate?i_id=" + this.state.i_id + "&pickupDate=" + this.state.pickup_date + "&deliveryDate=" + this.state.delivery_date;
