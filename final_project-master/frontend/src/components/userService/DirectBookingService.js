...
const EMPLOYEE_API_BASE_URL = "http://localhost:8090/customer/transporter";

const API = "http://localhost:8090/transporter/estimatedprice";

const ITEM_LIST_API = "http://localhost:8090/customer/itemdetails";
const API2 = "http://localhost:8090/admin/transporter";

const API3 = "http://localhost:8090/transporter/auctionitem";

const API4 = "http://localhost:8090/customer/auctionitembidder";

const API5 = "http://localhost:8090/customer/directhistory";

const API6 = "http://localhost:8090/customer/historyauctionitem";

const API7 = "http://localhost:8090/transporter/selectedBidders";

// const API8 = "http://localhost:8090/transporter/estimatedprice";
const API8 = "http://localhost:8090/admin/feedback";

const API9 = "http://localhost:8090/transporter/payment";

const API10 = "http://localhost:8090/admin/payment";

const API11 = "http://localhost:8090/admin/customer";

const API12 = "http://localhost:8090/transporter/selectedBidders";
 ...
 class DirectBookingService {
   ...
   getfeedback()
   {
    ...
    const feedback = axios.get("http://localhost:8090/admin/feedback");
